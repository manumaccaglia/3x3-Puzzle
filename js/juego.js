...
var instrucciones = ["Utilizar las flechas para mover la pieza libre." , "Ordenar las piezas hasta formar la imagen objetivo."];
...
function ultimoMovimiento(ultimaDireccion){
...
function mostrarCartelGanador() {
    //alert("Winner winner!\nChicken dinner!");
    swal("Winner winner!\nChicken dinner!", "Ganaste el juego!", "success");
}
